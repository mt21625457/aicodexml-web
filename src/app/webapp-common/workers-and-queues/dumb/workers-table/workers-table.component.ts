  ...
  protected cols = [
    {
      ...
      header: 'workers.table.headers.availableWorkers',
    ...
    },
    {
      ...
      headerType: ColHeaderTypeEnum.sortFilter,
      header: 'workers.table.headers.currentlyRunningTask',
      style: {width: '30%', maxWidth: '700px'},
      sortable: true,
    },
    {
      ...
      headerType: ColHeaderTypeEnum.sortFilter,
      header: 'workers.table.headers.taskRunningTime',
    ...
    },
    {
      ...
      headerType: ColHeaderTypeEnum.sortFilter,
      header: 'workers.table.headers.iteration',
