    ...
    const columns = [
      {
        ...
        header: 'queues.table.headers.queue',
      ...
      },
      {
        ...
        headerType: ColHeaderTypeEnum.sortFilter,
        header: 'queues.table.headers.workers',
        style: {width: '100px'},
        sortable: true,
      },
      {
        ...
        headerType: ColHeaderTypeEnum.sortFilter,
        header: 'queues.table.headers.nextTask',
      ...
      },
      {
        ...
        headerType: ColHeaderTypeEnum.sortFilter,
        header: 'queues.table.headers.lastUpdated',
      ...
      },
      {
        ...
        headerType: ColHeaderTypeEnum.sortFilter,
        header: 'queues.table.headers.inQueue',
